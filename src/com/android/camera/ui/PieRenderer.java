...
public class PieRenderer extends OverlayRenderer
    ...
    private static float RAD24 = (float) (24 * Math.PI / 180);
    ...
    private void cancelFocusAnimation() {
        ...
        if (mAnimator2 != null && mAnimator2.isStarted()) {
            mAnimator2.cancel();
        }
    ...
    private class Disappear implements Runnable {
        ...
        public void run() {
            if (mState == STATE_PIE) return;
            cancelFocusAnimation();
            mAnimator = ValueAnimator.ofInt(mFocusOuterRadius,
                    mFocusCircleRadius + mFocusCircleRadiusOffset);
            mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    mFocusOuterRadius = (int) animation.getAnimatedValue();
            ...
            mAnimator2 = ValueAnimator.ofInt(mFocusInnerRadius,
                    mFocusInnerRadius + mFocusCircleRadiusOffset);
