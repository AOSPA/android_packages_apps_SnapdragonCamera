...
public class PhotoUI extends CameraUI implements PieListener,
    ...
    public void onCameraOpened(PreferenceGroup prefGroup, ComboPreferences prefs,
        ...
        if (mGestures == null) {
            ...
            mGestures = new PreviewGestures(getActivity(), this, this, mZoomRenderer,
                    mPieRenderer, null);
        ...
        if (mController.isImageCaptureIntent()) {
            ...
            mReviewRetakeButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mController.isImageCaptureIntent()) {
                        getCameraControls().setTitleBarVisibility(View.VISIBLE);
                    }
                }
            });
        }
    ...
    protected void showCapturedImageForReview(byte[] jpegData, int orientation, boolean mirror) {
        getCameraControls().hideCameraSettings();
    ...
    protected void hidePostCaptureAlert() {
        getCameraControls().showCameraSettings();
