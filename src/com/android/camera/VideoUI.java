...
public class VideoUI extends CameraUI implements PieRenderer.PieListener,
    ...
    private void initializeOverlay() {
        ...
        if (mPieRenderer == null) {
            ...
            // mVideoMenu = new VideoMenu(getActivity(), this, mPieRenderer);
        ...
        if (mGestures == null) {
            mGestures = new PreviewGestures(getActivity(), this, this,
    ...
    public void showPopup(ListView popup, int level, boolean animate) {
        ...
        if (level == 1) {
            if (mMenuLayout == null) {
                mMenuLayout = new RotateLayout(getActivity(), null);
                if (getRootView().getLayoutDirection() != View.LAYOUT_DIRECTION_RTL) {
        ...
        if (level == 2) {
            if (mSubMenuLayout == null) {
                mSubMenuLayout = new RotateLayout(getActivity(), null);
